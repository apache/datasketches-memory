 ...
 * </ul>
 *
 * <p>More specifically, this package provides access to three different types of resources using
 * two different access APIs. These resources are contiguous blobs of bytes that provide at least
 * byte-level read and write access. The three resources are:</p>
 *
